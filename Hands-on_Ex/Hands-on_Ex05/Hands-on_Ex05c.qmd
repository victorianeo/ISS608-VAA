...
subtitle: "Lesson 5c: Heatmap for Visualising and Analysing Multivariate Data" 
author: "Victoria Neo"
date: 02/12/2024
...
# 3 [**Heatmap for Visualising and Analysing Multivariate Data**](https://r4va.netlify.app/chap14)
...
-   To reveal the relationship between high-dimensional variables pair-wisely. Heatmaps visualise data through variations in colouring. When applied to a tabular format, heatmaps are useful for cross-examining multivariate data, through placing variables in the columns and observation (or records) in rowa and colouring the cells within the table. Heatmaps are good for showing variance across multiple variables, revealing any patterns, displaying whether any variables are similar to each other, and for detecting if any correlations exist in-between them.
...
### 3.2.1 Installing and loading the required libraries

You will use the code chunk below to install and launch **seriation**, **heatmaply**, **dendextend** and **tidyverse** in RStudio.
...
#### 3.2.2.4 **Transforming the data frame into a matrix**
...
In the previous heatmap, red cells denotes small values, and red small ones. This heatmap is not really informative. Indeed, the Happiness Score variable have relatively higher values, what makes that the other variables with small values all look the same. Thus, we need to normalize this matrix. This is done using the scale argument. It can be applied to rows or to columns following your needs.
...
The default option is “OLO” (Optimal leaf ordering) which optimizes the above criterion (in O(n\^4)). 
...
### 3.4.4 **Working with colour palettes**
...
In the code chunk below, the Greys colour palette of rColorBrewer is used.
...
In the code chunk below, the Spectral colour palette of rColorBrewer is used.

```{r}
heatmaply(normalize(wh_matrix[, -c(1, 2, 4, 5)]),           seriate = "none",           colors = Spectral)
```

### 3.4.5 **The finishing touch**
