...
subtitle: "Lesson 5b: Visual Correlation Analysis" 
author: "Victoria Neo"
date: 02/9/2024
...
# 2 [**Visual Correlation Analysis**](https://r4va.netlify.app/chap06)
...
## 2.3: **Building Correlation Matrix: *pairs()* method**

There are more than one way to build scatterplot matrix with R. In this section, you will learn how to create a scatterplot matrix by using the *pairs* function of R Graphics. You can read more about the syntax description of [*pairs*](https://stat.ethz.ch/R-manual/R-devel/library/graphics/html/pairs.html)function.

### 2.3.1 **Building a basic correlation matrix**

::: panel-tabset
## Building the static correlation plot with Columns 1 - 11
...
## Building the static correlation plot with Columns 2 - 12
...
::: panel-tabset
## Lower half of static correlation plot
...
## Upper half of static correlation
...
::: panel-tabset
## Static correlation plot with correlation coefficients
...
::: panel-tabset
## Building the basic correlation plot
...
## Building the basic correlation plot with customization
...
grouped_ggcorrmat(
  ...
  ggcorrplot.args = list(lab_size = 3,
                         outline.color = "black", 
                         hc.order = TRUE,
                         tl.cex = 10),
...
## Building with "color" and "alphabet"
...
## Building with type "lower" and diag "FALSE" and black axis text label
...
## Building with type "lower" and rotated text labels and wider colour legend
...
## Building with removing color legend, text legend and principal diagonal glyph

```{r}
corrplot(wine.cor, 
         order = 'AOE', cl.pos = 'n', tl.pos = 'n',
...
::: panel-tabset
## Building a mixed layout corrogram with "ellipse" and "number"
...
```{r}
corrplot.mixed(wine.cor, 
         lower = 'shade', upper = 'pie', order = 'hclust', tl.cex = 0.25) 
```
:::
