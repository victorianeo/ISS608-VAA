...
subtitle: "Lesson 5d: Visual Multivariate Analysis with Parallel Coordinates Plot" 
author: "Victoria Neo"
date: 02/12/2024
...
# 4 [**Visual Multivariate Analysis with Parallel Coordinates Plot**](https://r4va.netlify.app/chap15)
...
In this hands-on exercise, the[World Happinees 2018](http://worldhappiness.report/ed/2018/) data will be used. The data set was download at this [link](https://s3.amazonaws.com/happiness-report/2018/WHR2018Chapter2OnlineData.xls). The original data set is in Microsoft Excel format. It has been extracted and saved in csv file called **WHData-2018.csv**.
