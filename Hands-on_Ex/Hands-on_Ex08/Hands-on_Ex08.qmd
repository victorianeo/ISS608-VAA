...
subtitle: "Lesson 8: [Modelling, Visualising and Analysing Network Data with R](https://r4va.netlify.app/chap27)" 
author: "Victoria Neo"
date: 03/7/2024
...
![*Taken from* [**How to map connections with great circles**](https://flowingdata.com/2011/05/11/how-to-map-connections-with-great-circles/)](images/clipboard-2906327176.png){fig-align="left"}
...
The data sets used in this hands-on exercise is from an oil exploration and extraction company. There are two data sets. One contains the nodes data and the other contains the edges (also know as link) data.They are:
...
#### 2.2.4.2 **Reviewing the revised date fields**
...
#### 2.2.4.4 **Reviewing the revised date fields**
...
### 3.3.2 **Changing the active object**
...
### 4.4.1 **Working with *facet_edges()***
...
### 4.4.4 **Working with *facet_nodes()***
