...
subtitle: "Lesson 9: [Modelling, Visualising and Analysing Network Data with R](https://r4va.netlify.app/chap27)" 
author: "Victoria Neo"
date: 03/7/2024
...
![*Taken from* [**Design Strategies for Information Dashboards**](https://www.webfx.com/blog/web-design/design-strategies-for-information-dashboards/)](images/clipboard-3234133424.png){fig-align="left"}

+------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Work done        | Hands-on Exercise 10                                                                                                                                                                                       |
+------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Hours taken      | ⏱️⏱️⏱️ \|                                                                                                                                                                                                  |
+------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Questions        | 0                                                                                                                                                                                                          |
...
| How do I feel?   | 🙃🙃                                                                                                                                                                                                       |
+------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| What do I think? | I really like sparklines! I think they are so cute and if they can be animated, it will be really cool! Dashboard design is something difficult for me as I usually end up with very cluttered dashboards. |
|                  |                                                                                                                                                                                                            |
|                  | I took really long on this exercise as I had to download a lot of packages and reinstall other packages. There were errors due to the wrong package versions.                                              |
|                  |                                                                                                                                                                                                            |
|                  | ![](images/clipboard-1317669558.png)                                                                                                                                                                       |
+------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
## 4.2 **sparklines: gtExtras method**
...
### 4.2.1 **Plotting Coffechain Sales report**
...
### 4.2.3 **Combining the data.frame**
...
### 4.2.4 **Plotting the updated data.table**
...
### 4.2.5 **Combining bullet chart and sparklines**
