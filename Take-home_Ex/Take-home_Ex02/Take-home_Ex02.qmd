...
![](images/clipboard-2948822257.png){width="418"}
:::
...
2)  Given that we want to find the effects of Gender, SES and Schools on Reading scores, Gender, SES and Schools should be independent/ X variables while reading scores is the Y variable.

3)  I think the choice of using the top 5 heavily represented schools is **not meaningful**. Moreover, using the label "top 5" is more traditionally associated with performance, rather than size of representation.
